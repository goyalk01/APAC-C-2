...
#
# MOVED AS-IS from swarmguard-ai/swarm_box/key_registry.py — logic unchanged,
# per ARCHITECTURE_PLAN.md constraint "don't touch business logic."
import json
import base64
import logging
...
def verify_payload(payload: dict) -> bool:
    ...
    Mirrors the signing logic in edge_nodes/edge_node.py exactly.
    """
    ...
    # serialized with compact separators — must match edge_node.py
