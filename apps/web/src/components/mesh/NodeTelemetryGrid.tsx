...
export const NodeTelemetryGrid: React.FC = () => {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex items-center justify-between p-2.5 px-3 rounded border text-[10px] font-mono"
        style={{
      ...
      >
        ...
        <span className="font-semibold uppercase tracking-wider text-[9px] border border-[var(--accent-warning-border)] px-1.5 py-0.5 rounded">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-4">
        {Object.entries(nodeTelemetry).map(([nodeId, t]) => {
          ...
          return (
            <div 
              key={nodeId}
              className="p-4 border rounded flex flex-col justify-between gap-3 shadow-sm font-mono text-xs transition-all duration-200"
              style={{
            ...
            >
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col gap-1">
                  <div className="flex justify-between text-[10px] text-neutral-500">
                    <span>CPU LOAD</span>
                    <span className="font-bold text-neutral-300">{cpuVal}%</span>
                  </div>
                ...
                <div className="flex flex-col gap-1">
                  <div className="flex justify-between text-[10px] text-neutral-500">
                    <span>MEMORY</span>
                    <span className="font-bold text-neutral-300">{ramVal}%</span>
                  </div>
                  <div className="w-full h-1.5 bg-[var(--bg-inset)] rounded-full overflow-hidden">
                    <div 
                      className="h-full rounded-full transition-all duration-500" 
                ...
                <div className="flex flex-col gap-1">
                  <div className="flex justify-between text-[10px] text-neutral-500">
                    ...
                    <span className="font-bold text-neutral-300">{signalVal} dBm</span>
                  </div>
                  <div className="w-full h-1.5 bg-[var(--bg-inset)] rounded-full overflow-hidden">
                    <div 
                      className="h-full rounded-full transition-all duration-500" 
                ...
                <div className="flex flex-col gap-1">
                  <div className="flex justify-between text-[10px] text-neutral-500">
                    <span>BATTERY</span>
                    <span className="font-bold text-neutral-300">{batteryVal}%</span>
                  </div>
                  <div className="w-full h-1.5 bg-[var(--bg-inset)] rounded-full overflow-hidden">
                    <div 
                      className="h-full rounded-full transition-all duration-500" 
              ...
              {/* Card Footer */}
              <div 
                className="flex items-center justify-between text-[10px] pt-2 border-t border-[var(--border-dim)]"
