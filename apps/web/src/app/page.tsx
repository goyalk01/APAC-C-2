        ...
        >
          ...
          >
            ...
            <div className="flex items-center gap-2">
              <span className="text-[10px] tracking-wider" style={{ color: 'var(--text-muted)' }}>ACTIVE SWEEP</span>
              <span 
          ...
          <div className="flex-1 relative bg-[var(--bg-inset)] min-h-[300px]">
            ...
            {/* Map Legend */}
            <div 
              className="absolute bottom-4 left-4 flex flex-wrap gap-4 text-[9px] font-mono p-2 border rounded-md backdrop-blur z-20"
              style={{
                backgroundColor: 'var(--bg-surface)',
                borderColor: 'var(--border)',
              }}
      ...
      <div className="lg:col-span-2 flex flex-col gap-6">
        ...
        >
          ...
          >
            ...
            <span 
              className="px-2 py-0.5 rounded-md text-[9px] font-sans font-bold border"
              style={{
                borderColor: 'var(--border)',
                backgroundColor: 'var(--bg-inset)',
